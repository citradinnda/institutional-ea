...
def main() -> int:
    ...
    parser.add_argument("--output", default="reports/h024_standard_demo_demo_order_canary_human_approval.jsonl")
    ...
    parser.add_argument("--approval-reference", default="manual_human_approval")
    ...
    print(f"Wrote H024 demo-order canary human approval: {args.output}")
