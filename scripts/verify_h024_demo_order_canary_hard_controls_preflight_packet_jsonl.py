...
def main() -> int:
    ...
    for index, record in enumerate(records):
        for violation in validate_demo_order_canary_hard_controls_preflight_packet(
            record,
    ...
    print(f"H024 demo-order canary hard-controls preflight packet records: {len(records)}")
