"""Scan real broker-native data for H018 guard violations.

Diagnostic-only:
- does not tune H017,
- does not execute fills,
- does not skip or clip trades in validation,
- does not promote H018,
...
from quantcore.backtest.h018_guard_scan import scan_h018_guard_violations
...
def main() -> None:
    print("H018 guard violation diagnostic scan")
    print("=" * 60)
    ...
    print("H018 guard diagnostic summary")
    print("-" * 40)
