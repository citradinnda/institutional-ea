...
def main() -> int:
    ...
    parser.add_argument("--canary-readiness-human-decision", default="reports/h024_standard_demo_demo_order_canary_readiness_human_decision.jsonl")
    parser.add_argument("--demo-order-readiness-packet", default="reports/h024_standard_demo_demo_order_readiness_packet.jsonl")
    parser.add_argument("--output", default="reports/h024_standard_demo_demo_order_canary_hard_controls_preflight_packet.jsonl")
    ...
    decision = _read_single_record(Path(args.canary_readiness_human_decision))
    ...
    record = build_demo_order_canary_hard_controls_preflight_packet(
        canary_readiness_human_decision=decision,
    ...
    print(f"Wrote H024 demo-order canary hard-controls preflight packet: {args.output}")
