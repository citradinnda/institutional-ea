...
def main() -> int:
    ...
    parser.add_argument("--canary-human-approval", default="reports/h024_standard_demo_demo_order_canary_human_approval.jsonl")
    parser.add_argument("--hard-controls-preflight-packet", default="reports/h024_standard_demo_demo_order_canary_hard_controls_preflight_packet.jsonl")
    parser.add_argument("--output", default="reports/h024_standard_demo_final_pre_dispatch_audit_packet.jsonl")
    ...
    approval = _read_single_record(Path(args.canary_human_approval))
    preflight = _read_single_record(Path(args.hard_controls_preflight_packet))
    record = build_final_pre_dispatch_audit_packet(
        canary_human_approval=approval,
        hard_controls_preflight_packet=preflight,
    ...
    print(f"Wrote H024 final pre-dispatch audit packet: {args.output}")
