...
1. derived-data provenance plan,
2. missing-minute coverage analysis,
3. weekend behavior analysis,
4. XAUUSD metals session-break analysis,
5. timezone/source-session reconciliation,
6. broker mismatch assessment versus Exness,
7. final HistData source acceptance or rejection decision.
