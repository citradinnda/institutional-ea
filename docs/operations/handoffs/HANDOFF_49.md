...
- `C:\Users\equin\Documents\institutional-ea\docs\operations\handoffs\HANDOFF_49.md`
...
- `Add handoff document #49 after invalid stop diagnostics`
...
Focused test results before this handoff:

- H018 guard scanner tests: `5 passed in 1.80s`
- H018 invalid-stop cause tests: `4 passed in 2.14s`
...
- Latest commit should be `Add handoff document #49 after invalid stop diagnostics`.
- Previous commit should be `11b27df Add H018 invalid stop cause diagnostic`.
...
- `docs/operations/handoffs/HANDOFF_49.md`
...
- `quantcore/strategy/heat_governor.py` if needed
...
- whether H017 uses signal sign in a way that can select a stop panel that is not protective for the active side.

Next useful diagnostic, if needed:

Count invalid-at-decision stops against H017 signal sign and both raw stop panels:
...
- `stops_long`
- `stops_short`
- whether `stops_long < decision_close`
- whether `stops_short > decision_close`
- selected stop based on position side
- invalid reason
...
First understand the stop/position generation.
...
Understood. Continuing after HANDOFF_49.

I understand:

- Windows / PowerShell / VS Code / Python 3.12.10 in `.venv`.
- Current branch should be `main`.
- Latest expected commit should be `Add handoff document #49 after invalid stop diagnostics`.
- Previous expected commit should be `11b27df Add H018 invalid stop cause diagnostic`.
...
- Guard scanner found 2271 violations, including 1545 invalid directional stops.
- Invalid-stop cause diagnostic found 1544 of 1545 invalid stops were already invalid at decision close.
- Next task is read-only inspection of H017 strategy stop/position generation.
- No code yet.
...
After hygiene passes, I will inspect H017 strategy stop/position logic before proposing any code change.