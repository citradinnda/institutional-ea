HANDOFF 38 - After H018 Governance Matrix, Claim Skeleton, And Decision-Record Template
This handoff is intentionally self-contained enough for a new AI to continue safely.

If any older handoff conflicts with this file, this HANDOFF_38 wins.
...
Latest expected commit before this HANDOFF_38 document is committed:

76a36d9 Add H018 decision record template
Expected latest commit after this handoff is committed:

Add handoff document #38 after H018 governance skeletons
...
Work Completed Since HANDOFF_37
Commit 0fc3fdf - Add H018 consolidated decision matrix
File added:
...
H017 remains failed.
H018 is governance-only.
Current H017 behavior.
H018 options under discussion.
Risk of each option.
Required synthetic tests.
Whether each option likely changes trade eligibility.
Whether each option likely changes realized exposure.
Whether each option likely requires H018.
Whether real-data runs would be diagnostic-only or H018 validation.
No threshold chosen.
No guard implemented.
No sizing reference chosen.
Full tests:

537 passed
Commit was pushed.

Commit d1ea6ae - Add H018 claim skeleton
File added:

docs/operations/H018_CLAIM_SKELETON.md
Documented:

Minimum required structure for any future H018 claim.
Required claim header.
Required boundary decisions before validation.
...
Commit 7c3d67c - Reference H018 claim skeleton
Files changed:
...
Commit 76a36d9 - Add H018 decision record template
File added:

docs/operations/H018_DECISION_RECORD_TEMPLATE.md
Documented:

Reusable template for future H018 decision records.
Required header.
...
Should the H018 decision-record template be referenced from status docs before any decision records are created?
Treat these as epistemic design decisions, not quick patches.

Recommended Next Path
Next logical sub-phase after HANDOFF_38 hygiene:

Phase 3.26-bt continued - Reference H018 decision-record template
Recommended priority:

Create a small documentation-only sync referencing:
...
Reference H018 decision record template
...
Absolute Do-Not Rules At HANDOFF_38
Do not:
...
Understood. I am continuing after HANDOFF_38.

I understand:

Windows / PowerShell / VS Code / Python 3.12.10 in .venv.
Current full-test anchor is 537 passed.
Latest expected commit is Add handoff document #38 after H018 governance skeletons.
Previous commit is 76a36d9 Add H018 decision record template.
...
Recommended next logical sub-phase is documentation-only reference of H018_DECISION_RECORD_TEMPLATE.md.
